...
class MissingTransactionsManagerTest(AbstractTestCase):
    ...
    def _add_broadcast_message(self, existing_msgs_count=0):
        ...
        self.assertEqual(len(self.missing_tx_manager.block_hash_to_msg), existing_msgs_count)
        self.assertEqual(len(self.missing_tx_manager.block_hash_to_sids), existing_msgs_count)
        self.assertEqual(len(self.missing_tx_manager.block_hash_to_tx_hashes), existing_msgs_count)

        self.assertEqual(len(self.missing_tx_manager.block_add_times), existing_msgs_count)

        self.assertEqual(len(self.missing_tx_manager.sid_to_block_hash), existing_msgs_count * 3)
        ...
        self.assertEqual(len(self.missing_tx_manager.block_hash_to_tx_hashes), existing_msgs_count + 1)

        self.assertEqual(len(self.missing_tx_manager.block_add_times), existing_msgs_count + 1)

        self.assertEqual(len(self.missing_tx_manager.sid_to_block_hash), existing_msgs_count * 3 + 3)
