...
class ThroughputServiceTests(AbstractTestCase):
    ...
    def setUp(self):
        ...
        self.inbound_throughput_event1 = ThroughputEvent(NetworkDirection.INBOUND, "test_in_msg", 100, "localhost 0000")
        self.inbound_throughput_event2 = ThroughputEvent(NetworkDirection.INBOUND, "test_in_msg", 50, "localhost 0000")
        self.inbound_throughput_event3 = ThroughputEvent(NetworkDirection.INBOUND, "mock_msg", 60, "localhost 0000")

        self.outbound_throughput_event1 = ThroughputEvent(NetworkDirection.OUTBOUND, "test_out_msg", 100, "localhost 0000")
        self.outbound_throughput_event2 = ThroughputEvent(NetworkDirection.OUTBOUND, "test_out_msg", 75, "localhost 0000")
    ...
    def test_add_throughput_event_peer_count(self):
        ...
        throughput_statistics.add_event(NetworkDirection.INBOUND, "mock_msg", 100, "localhost 0000")
...
###
    ...
    def test_adding_ping_event(self):
        add_throughput_event(NetworkDirection.INBOUND,"ping", 40, "localhost 0000")
    ...
    def test_adding_ping_inbound_event(self):
    ...
    def test_adding_ping_outbound_event(self):
        ...
        self.assertEqual(throughput_statistics.interval_data.peer_to_stats["localhost 0000"].ping_outgoing_max, 0.3)
        throughput_statistics.flush_info()
