...
class TestInputBuffer(unittest.TestCase):
    ...
    def test_peek_message(self):
        ...
        self.assertEqual(bytearray([i for i in range(1, 6)]), self.in_buf.peek_message(5))
        self.assertEqual(bytearray([i for i in range(1, 31)]), self.in_buf.peek_message(30))
        self.assertEqual(bytearray([i for i in range(1, 61)]), self.in_buf.peek_message(60))
