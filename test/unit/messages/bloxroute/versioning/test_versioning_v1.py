...
class VersioningV1Tests(AbstractTestCase):

    def test_convert_message_to_older_version__hello_message_v1(self):
        dummy_idx = 11

        hello_msg = HelloMessage(protocol_version=versioning.CURRENT_PROTOCOL_VERSION,
                                 idx=dummy_idx,
                                 network_num=DEFAULT_NETWORK_NUM)

        hello_msg_v1 = versioning.convert_message_to_older_version(1, hello_msg)
    ...
    def test_convert_message_from_older_version__hello_message_v1(self):
        ...
        hello_msg = versioning.convert_message_from_older_version(1, hello_msg_v1)
    ...
    def test_convert_message_to_older_version__tx_message_v1(self):
        ...
        tx_msg_v1 = versioning.convert_message_to_older_version(1, tx_msg)
        ...
        self.assertRaises(ValueError, versioning.convert_message_to_older_version, 1, tx_msg_not_convertable)
    ...
    def test_convert_message_from_older_version__tx_message_v1(self):
        ...
        tx_msg = versioning.convert_message_from_older_version(1, tx_msg_v1)
    ...
    def test_convert_message_to_older_version__key_message_v1(self):
        msg_hash = self._get_random_hash()
        ...
        key_msg_v1 = versioning.convert_message_to_older_version(1, key_msg)
        ...
        self.assertRaises(ValueError, versioning.convert_message_to_older_version, 1, key_msg_not_convertable)
    ...
    def test_convert_message_from_older_version__key_message_v1(self):
        ...
        key_msg = versioning.convert_message_from_older_version(1, key_msg_v1)
    ...
    def test_convert_message_to_older_version__broadcast_message_v1(self):
        random_hash = self._get_random_hash()
        ...
        broadcast_msg_v1 = versioning.convert_message_to_older_version(1, broadcast_msg)
    ...
    def test_convert_message_from_older_version__broadcast_message_v1(self):
        ...
        broadcast_msg = versioning.convert_message_from_older_version(1, broadcast_msg_v1)
    ...
    def test_convert_first_bytes__to_older_version__broadcast_message_v1(self):
        ...
        broadcast_msg_v1_bytes = versioning.convert_message_first_bytes_to_older_version(1,
    ...
    def test_convert_first_bytes_from_older_version__broadcast_message_v1(self):
        ...
        broadcast_msg_bytes = versioning.convert_message_first_bytes_from_older_version(1,
                                                                                        BloxrouteMessageType.BROADCAST,
    ...
    def test_size_change(self):
        self.assertEqual(-NETWORK_NUM_LEN,
                         versioning.get_message_size_change_to_older_version(1, BloxrouteMessageType.BROADCAST))
        self.assertEqual(NETWORK_NUM_LEN,
                         versioning.get_message_size_change_from_older_version(1, BloxrouteMessageType.BROADCAST))

    def _test_message_does_not_change(self, cls, *args):
        message = cls(*args)
        message_v1 = versioning.convert_message_to_older_version(1, message)
        self.assertIsInstance(message_v1, cls)
        self.assertEqual(message, message_v1)

        message_v1 = cls(*args)
        message = versioning.convert_message_from_older_version(1, message_v1)
