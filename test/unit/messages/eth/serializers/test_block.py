...
class TestBlock(AbstractTestCase):
    def test_berlin_block_from_bytes(self):
        block_bytes = bytearray.fromhex(eth_fixtures.BERLIN_BLOCK_BODIES)
        block: Block = rlp.decode(block_bytes, Block)

        self.assertEqual(
            Sha256Hash.from_string("0ad3836807aa90218884be62c8dd912fe5228aafa6fc2a7c21028e8c09bc91ef"),
        ...
        self.assertEqual(
            Sha256Hash.from_string("77b19baa4de67e45a7b26e4a220bccdbb6731885aa9927064e239ca232023215"),
            legacy_tx.hash()
        )

        al_tx = block.transactions[1]
        self.assertIsInstance(al_tx, AccessListTransaction)
        self.assertEqual(
            Sha256Hash.from_string("554af720acf477830f996f1bc5d11e54c38aa40042aeac6f66cb66f9084a959d"),
            al_tx.hash()
        )
    ...
    def test_berlin_block_to_json(self):
        ...
        al_tx = block_json["transactions"][1]
        self.assertEqual(
        ...
        self.assertIn("access_list", al_tx)
