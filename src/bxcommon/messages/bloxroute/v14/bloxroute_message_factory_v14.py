...
class _BloxrouteMessageFactoryV14(AbstractMessageFactory):
    _MESSAGE_TYPE_MAPPING = {
        # pylint: disable=protected-access
        **bloxroute_message_factory_v15._MESSAGE_TYPE_MAPPING,
        BloxrouteMessageType.BDN_PERFORMANCE_STATS: BdnPerformanceStatsMessageV14,
    }

    def __init__(self) -> None:
        super(_BloxrouteMessageFactoryV14, self).__init__(self._MESSAGE_TYPE_MAPPING)
...
bloxroute_message_factory_v14 = _BloxrouteMessageFactoryV14()
