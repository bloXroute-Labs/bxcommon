...
class _BloxrouteMessageFactoryV9(AbstractMessageFactory):
    _MESSAGE_TYPE_MAPPING = {
        # pylint: disable=protected-access
        **bloxroute_message_factory_v10._MESSAGE_TYPE_MAPPING,
        BloxrouteMessageType.BDN_PERFORMANCE_STATS: BdnPerformanceStatsMessageV9
    }

    def __init__(self) -> None:
        super(_BloxrouteMessageFactoryV9, self).__init__(self._MESSAGE_TYPE_MAPPING)
...
bloxroute_message_factory_v9 = _BloxrouteMessageFactoryV9()
