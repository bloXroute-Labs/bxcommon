...
class _MessageConverterFactoryV9(AbstractMessageConverterFactory):
    _MESSAGE_CONVERTER_MAPPING = {
        # pylint: disable=protected-access
        **message_converter_factory_v10._MESSAGE_CONVERTER_MAPPING,
...
message_converter_factory_v9 = _MessageConverterFactoryV9()
