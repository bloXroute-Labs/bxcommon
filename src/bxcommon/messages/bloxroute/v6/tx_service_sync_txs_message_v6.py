...
class TxServiceSyncTxsMessageV6(AbstractBloxrouteMessage):
    ...
    def txs_content_short_ids(self) -> List[TxContentShortIdsV6]:
        ...
        return txs_serializer_v6.deserialize_txs_content_short_ids_from_buffer(self._memoryview, offset, self.tx_count())
    ...
    def _parse(self) -> None:
        ...
        self.buf.extend(txs_serializer_v6.serialize_txs_content_short_ids_into_bytes(self._txs_content_short_ids,
                                                                                     self.network_num()))
