...
class _BloxrouteMessageFactoryV15(AbstractMessageFactory):
    _MESSAGE_TYPE_MAPPING = {
        # pylint: disable=protected-access
        **bloxroute_message_factory_v16._MESSAGE_TYPE_MAPPING,
        BloxrouteMessageType.TRANSACTION: TxMessageV15,
        BloxrouteMessageType.TX_SERVICE_SYNC_TXS: TxServiceSyncTxsMessageV15,
    }

    def __init__(self) -> None:
        super(_BloxrouteMessageFactoryV15, self).__init__(self._MESSAGE_TYPE_MAPPING)
...
bloxroute_message_factory_v15 = _BloxrouteMessageFactoryV15()
