...
from bxcommon.messages.bloxroute.v22.bloxroute_message_factory_v22 import bloxroute_message_factory_v22
...
class _BloxrouteMessageFactoryV21(AbstractMessageFactory):
    _MESSAGE_TYPE_MAPPING = {
        # pylint: disable=protected-access
        **bloxroute_message_factory_v22._MESSAGE_TYPE_MAPPING,
        BloxrouteMessageType.TRANSACTION: TxMessageV21,
    }

    def __init__(self) -> None:
        super(_BloxrouteMessageFactoryV21, self).__init__(self._MESSAGE_TYPE_MAPPING)
...
bloxroute_message_factory_v21 = _BloxrouteMessageFactoryV21()
