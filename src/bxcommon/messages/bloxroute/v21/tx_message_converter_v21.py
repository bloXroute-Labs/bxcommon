...
class _TxMessageConverterV21(AbstractMessageConverter):
    ...
    def convert_to_older_version(
        ...
        if msg_type not in self._MSG_TYPE_TO_OLD_MSG_CLASS_MAPPING:
            raise ValueError(
                ...
                f"message type to v21: {msg_type}"
            )
...
tx_message_converter_v21 = _TxMessageConverterV21()
