...
class _BloxrouteMessageFactoryV19(AbstractMessageFactory):
    ...
    def __init__(self) -> None:
        super(_BloxrouteMessageFactoryV19, self).__init__(self._MESSAGE_TYPE_MAPPING)
...
bloxroute_message_factory_v19 = _BloxrouteMessageFactoryV19()
