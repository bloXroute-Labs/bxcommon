...
class _BloxrouteMessageFactoryV20(AbstractMessageFactory):
    _MESSAGE_TYPE_MAPPING = {
        # pylint: disable=protected-access
        **bloxroute_message_factory_v21._MESSAGE_TYPE_MAPPING,
        BloxrouteMessageType.TRANSACTION: TxMessageV20,
    }

    def __init__(self) -> None:
        super(_BloxrouteMessageFactoryV20, self).__init__(self._MESSAGE_TYPE_MAPPING)
...
bloxroute_message_factory_v20 = _BloxrouteMessageFactoryV20()
