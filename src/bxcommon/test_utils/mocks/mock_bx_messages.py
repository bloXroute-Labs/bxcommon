...
def broadcast_key_pair(short_ids=None, network_num=0):
    ...
    broadcast_message_bytes = compact_block_short_ids_serializer.serialize_short_ids_into_bytes(short_ids)
    ...
    broadcast_message = BroadcastMessage(broadcast_message_hash, network_num, enc_broadcast_message_bytes)
