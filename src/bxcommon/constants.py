...
ETHEREUM_SOLANA_MAINNET_NETWORK_NUM: int = 41
ETHEREUM_KILN_MAINNET_NETWORK_NUM: int = 42
...
BLOCKCHAIN_NETWORK_NUM_TO_NETWORK_NAME = {
    ...
    ETHEREUM_SOLANA_MAINNET_NETWORK_NUM: "Solana",
    ETHEREUM_KILN_MAINNET_NETWORK_NUM: "Kiln",
}
