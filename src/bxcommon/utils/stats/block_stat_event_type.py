class BlockStatEventType(object):
    ...
    BLOCK_HOLD_REQUESTED = "BlockHoldRequested"
    BLOCK_HOLD_HELD_BLOCK = "BlockHoldHeldBlock"
    BLOCK_HOLD_LIFTED = "BlockHoldLifted"
    BLOCK_HOLD_TIMED_OUT = "BlockHoldTimeout"
    ...
    ENC_BLOCK_RECEIVED_BY_GATEWAY_FROM_NETWORK = "EncBlockReceivedByGatewayFromNetwork"
    ENC_BLOCK_DECRYPTED_SUCCESS = "EncBlockDecryptedSuccess"
    ENC_BLOCK_SENT_BLOCK_RECEIPT = "EncBlockSentBlockReceipt"
    ...
    ENC_BLOCK_KEY_SENT_FROM_GATEWAY_TO_NETWORK = "EncBlockKeySentFromGatewayToNetwork"
