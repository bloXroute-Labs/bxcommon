...
def increment_obj_mem_stats(class_name, network_num, obj, obj_name, obj_mem_info, object_item_count=None):
    return memory_statistics.increment_mem_stats(class_name, network_num, obj, obj_name, obj_mem_info, object_item_count)
